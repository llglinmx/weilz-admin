				...
				<view class="box-content-info-bottom">
					...
					<view class="box-content-info-bottom-item">
						<view class="box-content-info-bottom-item-wrap">
							...
							<view class="box-content-info-bottom-item-text">{{dataObj.total_orders}}</view>
						</view>
					</view>
					<view class="box-content-info-bottom-item">
						<view class="box-content-info-bottom-item-wrap">
							...
							<view class="box-content-info-bottom-item-text">{{dataObj.service_commission}}</view>
						</view>
					</view>
					<view class="box-content-info-bottom-item">
						<view class="box-content-info-bottom-item-wrap">
							...
							<view class="box-content-info-bottom-item-text">{{dataObj.buy_amount}}</view>
						</view>
					</view>
					<view class="box-content-info-bottom-item">
						<view class="box-content-info-bottom-item-wrap">
							...
							<view class="box-content-info-bottom-item-text">{{dataObj.reward}}</view>
						</view>
					</view>
					<view class="box-content-info-bottom-item">
						<view class="box-content-info-bottom-item-wrap">
							...
							<view class="box-content-info-bottom-item-text">{{dataObj.service_num}}</view>
						</view>
					</view>
				...
				<view class="box-content-data-list">
					<swiper class="swiper-box" :current="defaultIndex" @change="tabChange">
						<swiper-item class="swiper-box-item-list" v-for="(item,index) in tabsList" :key='index'>
							<technician-data-swiper ref='refSwiper' :time='timeObj' :id='id' :type='type' :tabIndex="index"
