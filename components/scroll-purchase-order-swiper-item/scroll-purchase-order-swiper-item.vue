					...
					<view class="box-content-order-list-li" v-for="(item,index) in dataList" :key="item.id"
						...
						<view class="box-content-order-list-li-footer">
							...
							<view class="box-content-order-list-li-footer-btn">
								<view class="order-list-li-footer-all-btn btn-blue flex-center" v-if="index==3">评价订单
								</view>
								<view class="order-list-li-footer-all-btn btn-hollow flex-center" v-if="index==2"
									@click.stop="viewLogistics">查看物流</view>
								<view class="order-list-li-footer-all-btn btn-blue flex-center" v-if="index==2">确认收货
								</view>
								<view class="order-list-li-footer-all-btn btn-hollow flex-center" v-if="index==0">取消订单
								</view>
								<view class="order-list-li-footer-all-btn btn-fill flex-center" v-if="index==0">去付款
								</view>
