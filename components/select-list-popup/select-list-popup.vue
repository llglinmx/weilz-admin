						...
						<view class="popup-box-content-list-li-info">
							...
							<view class="list-li-info-main">
								...
								<view class="list-li-info-main-item">
									<view class="list-li-info-main-item-li">{{item.service_time}}分钟</view>
									<view class="list-li-info-main-item-li" v-for="(j,i) in item.format">{{j.name}}
									</view>
								</view>
								<view class="list-li-info-main-price">{{item.price}}</view>
							</view>
						</view>
		...
		.popup-box-main {
			...
			.popup-box-content {
				...
				.popup-box-content-list {
					...
					.popup-box-content-list-li:first-child {
						margin-top: 0;
					}
